...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\keyfixer on
     Windows, /home/user/dev/keyfixer on Linux) in a file named
     keyfixer@mavaball.net and copy that file to
